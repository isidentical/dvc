...
class HDFSFileSystem(CallbackMixin, FSSpecWrapper):
    ...
    def _get_kwargs_from_urls(urlpath):
        from fsspec.implementations.arrow import HadoopFileSystemWrapper

        # pylint:disable=protected-access
        return HadoopFileSystemWrapper._get_kwargs_from_urls(urlpath)
    ...
    def fs(self):
        ...
        return HadoopFileSystemWrapper(**self.fs_args)
